...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        $rules = config('Validation')->registrationRules ?? [
            ...
            'nim'      => 'required|numeric|exact_length[7]|is_unique[users.nim]',
        ];
        ...
        // Save the user
        $allowedPostFields = array_merge(['password', 'nim'], $this->config->validFields, $this->config->personalFields);
        $user              = new User($this->request->getPost($allowedPostFields));

        // Debug user entity before saving
        var_dump($user); // Menampilkan data user yang akan disimpan
